...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-12-2023 a las 01:17:00
...
SELECT postu.id_postula, postu.estado_noti,  oft.puesto, postu.fk_id_oferta_trabajo FROM postula as postu
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `postulacionAprobada` (`id_estudiante` INT)   BEGIN
	SELECT * FROM usuario_empresa as usuEm 
	LEFT JOIN oferta_trabajo as ofert 
	ON usuEm.id_usuario_empresa = ofert.fk_id_usuario_empresa
	...
	WHERE postu.aprobado = 1 AND postu.fk_id_usuEstudiantes = id_estudiante
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `todasLasNotificaciones` (`id_aspirante` INT, `desde` INT, `limite` INT)   BEGIN
	SELECT usuEm.id_usuario_empresa, oft.id_oferta_trabajo, dtEm.imagen_perfil, dtEm.nombre, oft.puesto, oft.tipo_empleo, oft.precio, post.fecha_aprobado FROM usuario_estudiantes usuEs
...
(2, 'Ciencias en la Salud', 'Medicina', 'Lic. medico', 0),
(3, 'Ciencias Economicas', 'Contavilidad', 'Lic. Contavilidad', 0),
...
(54, 'Pasante', 'Soy una persona apasionada a la programación, con capacidad de resolver problemas nuevos', 'Tengo un solido conocimiento en diseño web', 'Programador Web', 'https://tattoosmoking.000webhostapp.com', 'https://drive.google.com/file/d/1-w-ZkBYYK7DhQEea-xwO30aL7ZFdtVLM/view?usp=drivesdk', 36),
...
(33, 'Coral', 'Cajero', 'Cobrar productos en línea de cajas. Abrir y cerrar la caja, realizando la puesta en marcha de la caja y el retiro del dinero y recuento de caja al finalizar. Informar y atender al cliente.', '2 Años', 54),
...
(86, 'borrar', 0, 'Manta', 'asdasd', 'asdasd', '2023-12-16', 1, 14, 28, 13, 1, 19),
(87, 'editado', 5, 'Manta editrado', 'taera editado', 'detalle editado', '2023-12-16', 1, 13, 26, 12, 1, 19);
...
(61, '2023-12-16', 0, NULL, 0, 1, 36, 19, 87),
(62, '2023-12-16', 0, NULL, 0, 1, 38, 19, 87);
...
INSERT INTO `usuario_empresa` (`id_usuario_empresa`, `correo`, `contra`, `estado_cuenta`, `contra_temporal`, `fecha_creacion`) VALUES
(19, 'InnoVistaTech@gmail.com', '26551699ab6fee5e42c980704ade76ec3e1b46a1', 1, NULL, '2023-12-11 15:55:45');
...
--
ALTER TABLE `conocimientos`
  MODIFY `id_conocimientos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `postula`
  MODIFY `id_postula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT de la tabla `publicidad`
--
ALTER TABLE `publicidad`
  MODIFY `id_publicidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `referencia`
--
ALTER TABLE `referencia`
  MODIFY `id_referencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
