...
// ACTIVAR
if (isset($_REQUEST['id_activar'])) {

    if ($_REQUEST['id_activar'] == "") {
        echo "ID vacio";
        die();
    }

    $id_aspirante = $_REQUEST['id_activar'];

    $queryEliminar = mysqli_query($conn, "UPDATE usuario_estudiantes SET estado_cuenta = '1' WHERE id_usuEstudiantes = '$id_aspirante' ");
...
<body>
    ...
    <main class="main container">
        ...
        ?>
                <div class="bg-dark ">
                    <div class="cartaAspirante text-light">
                        ...
                        <span class="cedula"> <?php //echo $recorrerDatosAspirante['cedula'] 
                                                ?> </span>
                        <span class="nombre"> <?php //echo $recorrerDatosAspirante['nombre'], " ", $recorrerDatosAspirante['apellido'] 
                                                ?> </span>
                        ...
                        <div class="acciones">
                            ...
                            <span>
                                <a class="text-light" href="?id_aspirante=<?php //echo $recorrerDatosAspirante['id_usuEstudiantes']
                                                                            ?>">Editar</a>
                            </span>
        ...
        <section class="mb-3 ">
            ...
            <h1 class="text-danger"> Cuentas Eliminadas (<?php echo $totalAspirantes ?>) </h1>
                ...
                ?>
                    <div>
                        <div class="cartaAspirante">
                            ...
                            <div class="acciones">
                                <span><a onClick="confirmacion(event)" href="?id_activar=<?php echo $recorrerListaAspirante['id_usuEstudiantes'] ?>">✔️</a></span>
        ...
        <!-- <section class="seccionBuscar ">
            ...
            <form action="" method="post" class="formularioBuscar">
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="floatingInput">Cedula o Nombre y Apellido*</label>
                </div>
