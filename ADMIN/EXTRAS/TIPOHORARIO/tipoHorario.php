...
if (isset($_REQUEST['eliminar'])) {
    ...
    $queryEliminar = mysqli_query($conn, "DELETE FROM tipo_horario_oferta WHERE id_tipo_horario_oferta = '$id_eliminar' ");
    if ($queryEliminar > 0) {
        echo '<script>  
            alert("Eliminado")
            window.history.back()
...
<head>
    ...
    <link rel="stylesheet" href="estiloTipoHorario.css">
...
<body>
    ...
    <!-- ICONO DEL CORAZON -->
    <img class="iconoSpiderman" src="../../../imagenes/Iconos/iconoAdmin/corazon.gif" width="100px" alt="">
    ...
    <main class="main">
        ...
        <section class="seccionTipoOferta">
            ...
            <h1>Horario de la oferta</h1>
            <hr>

            <ul id="ul">
                <?php
                $queryDatosOferta = mysqli_query($conn, "SELECT * FROM tipo_horario_oferta ORDER BY id_tipo_horario_oferta DESC");

                while ($recorrerDatosOferta = mysqli_fetch_array($queryDatosOferta)) {
                ?>
                    <li><?php echo $recorrerDatosOferta['nombre'] ?> <a href="?eliminar=<?php echo $recorrerDatosOferta['id_tipo_horario_oferta'] ?>">&times;</a></li>
                <?php
                }
        ...
        <section class="seccionFormulario">
            ...
            <form action="" id="formulario">
                ...
                <h1>Ingresar Horario de la Oferta</h1>
                <hr>

                <div class="mb-3">
                    <label for="nombreHoraOferta" class="form-label">Nombre de la Hora oferta*</label>
                    <input type="text" class="form-control" id="nombreHoraOferta" name="nombreHoraOferta" placeholder="Nombre de la Hora oferta" required>
                </div>
            ...
            fetch('./ingresarTipoHorario.php', {
                ...
                .then(e => {
                    ...
                    if (e.mensaje == "DATOS INSERTADOS") {
                        ...
                        ul.insertAdjacentHTML('afterbegin', `<li>${formdata.get('nombreHoraOferta')} <a href='?eliminar=${e.id}'> &times; </a> </li>`)


                        // limpiar el input
                        document.getElementById('nombreHoraOferta').value = ''
