...
if (isset($_REQUEST['eliminar'])) {
    ...
    $queryEliminar = mysqli_query($conn, "DELETE FROM tipos_oferta WHERE id_tipo_oferta = '$id_eliminar' ");
    if ($queryEliminar > 0) {
        echo '<script>  
            alert("Eliminado")
            window.history.back()
...
<head>
    ...
    <link rel="stylesheet" href="estiloTipoOferta.css">
...
<body>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <div class="dropdown activo">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="">Tipo Oferta Empleo</a></li>
    ...
    <main class="main">
        ...
        <section class="seccionTipoOferta">
            ...
            <h1>Tipos de ofertas</h1>
            <hr>

            <ul id="ul">
                <?php
                $queryDatosOferta = mysqli_query($conn, "SELECT * FROM tipos_oferta ORDER BY id_tipo_oferta DESC");

                while ($recorrerDatosOferta = mysqli_fetch_array($queryDatosOferta)) {
                ?>
                    <li><?php echo $recorrerDatosOferta['nombre'] ?>
                        <span onclick="desactivar(<?php echo $recorrerDatosOferta['id_tipo_oferta'] ?>)" style="cursor: pointer; color: blue; text-decoration: underline;">&times;</span>
                    </li>
                <?php
                }
        ...
        <section class="seccionFormulario">
            ...
            <form action="" id="formulario">
                ...
                <h1>Ingresar Tipo Oferta</h1>
                <hr>

                <div class="mb-3">
                    <label for="nombreOferta" class="form-label">Nombre de la oferta*</label>
                    <input type="text" class="form-control" id="nombreOferta" name="nombreOferta" placeholder="Nombre de la oferta" required>
                </div>
            ...
            fetch('./ingresarTipoOferta.php', {
                ...
                .then(e => {
                    ...
                    if (e.mensaje == "DATOS INSERTADOS") {
                        ...
                        ul.insertAdjacentHTML('afterbegin', `<li>${formdata.get('nombreOferta')} <a href='?eliminar=${e.id}'> &times; </a> </li>`)
