...
$queryComentariosAspirantesSinLimite = mysqli_query($conn, "SELECT comen.id_comentario FROM comentarios  comen  WHERE comen.fk_id_usuEstudiantes IS NOT null ORDER BY comen.id_comentario DESC ");
...
$queryComentariosAspirantes = mysqli_query($conn, "SELECT comen.id_comentario, comen.comentario, comen.fecha , dt.nombre ,dt.imagen_perfil FROM comentarios  comen
                                                        ...
                                                        WHERE comen.fk_id_usuEstudiantes IS NOT null ORDER BY comen.id_comentario DESC LIMIT $desde, $limiteConsulta ");
...
<body>
    ...
    <header class="p-3">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active disabled" aria-current="page" href="">Aspirantes (<?php echo $totalComentarios ?>)</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="./comentariosEmpresas.php">Empresas</a>
            </li>
            <li class="nav-item">
